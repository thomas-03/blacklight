...
void MCReader::ReadHDF5StringArray(const char *name, bool allocate,
...
// Notes:
//   Changes stream pointer.
void MCReader::ReadHDF5IntArray(const char *name, Array<int> &int_array)
{
  // Locate header
  unsigned long int header_address =
      ReadHDF5DatasetHeaderAddress(name, root_btree_address, root_data_segment_address);
...
// Notes:
//   Changes stream pointer.
void MCReader::ReadHDF5FloatArray(const char *name, Array<float> &float_array)
{
  // Locate header
  unsigned long int header_address =
      ReadHDF5DatasetHeaderAddress(name, root_btree_address, root_data_segment_address);
...
// Notes:
//   Changes stream pointer.
void MCReader::ReadHDF5FloatArray(const char *name, Array<double> &double_array)
{
  // Locate header
  unsigned long int header_address =
      ReadHDF5DatasetHeaderAddress(name, root_btree_address, root_data_segment_address);
...
// Notes:
//   Changes stream pointer.
void MCReader::ReadHDF5DoubleArray(const char *name, Array<double> &double_array)
{
  // Locate header
  unsigned long int header_address =
      ReadHDF5DatasetHeaderAddress(name, root_btree_address, root_data_segment_address);
...
//   Must be a 1D array.
void MCReader::SetHDF5StringArray(const unsigned char *datatype_raw,
...
void MCReader::SetHDF5IntArray(const unsigned char *datatype_raw,
...
//   Must be run on little-endian machine.
void MCReader::SetHDF5FloatArray(const unsigned char *datatype_raw,
...
//   Must be run on little-endian machine.
void MCReader::SetHDF5DoubleArray(const unsigned char *datatype_raw,
    const unsigned char *dataspace_raw, const unsigned char *data_raw, Array<double> &double_array)
{
  // Check datatype version and class
  int offset = 0;
