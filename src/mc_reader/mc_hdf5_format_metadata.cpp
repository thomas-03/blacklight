...
unsigned long int MCReader::ReadHDF5DatasetHeaderAddress(const char *name,
...
//   Must have size of offsets 8.
//   Must be run on little-endian machine.
void MCReader::ReadHDF5DataObjectHeader(unsigned long int data_object_header_address,
...
//   Must be run on little-endian machine.
void MCReader::ReadHDF5DataspaceDims(const unsigned char *dataspace_raw,
